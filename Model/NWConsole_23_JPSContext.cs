...
{
    public partial class NWConsole_23_JPSContext : DbContext
    {
        public NWConsole_23_JPSContext()
        {
        }

        public NWConsole_23_JPSContext(DbContextOptions<NWConsole_23_JPSContext> options)
            : base(options)
        {
        }
